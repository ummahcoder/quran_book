Map<String, String> zikrs = {
  "Allohumma innaka 'afuvvun tuhibbul 'afva fa'fa 'anniy":
      "Yo Alloh, albatta, Sen kechirguvchisan, kechirishni yaxshi ko'rasan. Meni (gunohlarimni) kechirgin",
  "Allohumma aslih ahvalal muslimiyna fil Filistin, Allohumma aslih ahvalal\nmuslimiynia fi Filistin va fi kulli\nmakaan, yaa zal jalaali val ikrom":
      "Yo Alloh, Falastindagi musulmonlarning\nholatlarini isloh qil. Yo Alloh, Falastin va butun dunyodagi musulmonlarning\nholatlarini isloh qil, ey ulug'lik, kamol va\nazamat Sohibi, ey ato va karam Sohibi",
  "Laa ilaaha illaloh": "Allohdan o'zga iloh yo'q",
  "Allohumma solli 'alaa Muhammadin\nva 'alaa aali Muhammad":
      "Allohim! Muhammadga va\nMuhammadning oila a'zolariga\n O'zingning ziyoda rahmatlaringni nozil qilgin!",
  "Astag'firulloh": "Allohdan kechirim so'rayman",
  "Subhanalloh": "Alloh taolo barcha kamchiliklardan pok Zotdir!",
  ...
  "Allohumma bika amsaynaa va bika nah'ya va bika namutu va ilaykan nushur":
  ...
  "Laa havla va laa quvvata illaa billaah":
      "Kuch ham, quvvat ham faqat Alloh bilandir",
  "Hasbunallohu va ni'mal-vakiyl":
      "Bizga Allohning O'zi kifoyadir. U qanday yaxshi vakildir",
  "Alohumma a'inni ala zikrika va shukrika va husni ibadatika":
      "Allohim, Seni zikr qilishda, Senga shukr qilishda vs Senga go'zal ibodat qilishda menga yordam ber",
  "Subhaanalloh valhamdu liilaah, va laa ilaaha illallohu vallohu akbar":
      "Allohni poklab yod etaman. Allohdan o'zga iloh yo'q. Alloh buyukdir",
  "Laa ilaaha illalloh, Muhammadur-rosululloh":
      "Allohdan o'zga iloh yo'q. Muhammad Allohnng elchisidir",
  "Laa ilaaha Anta subhanaka inniy kuntu min az-zolimin":
      "Sendan o'zga haq iloh yo'q. Sen barcha aybu nuqsonlardam poksan. Darhaqiqat, men zulm qiluvchilardan bo'ldim",
  "All`ohu l`a il`aha ill`a huval hayyul qoyy`um. L`a ta'xuzuh`u sinatuv-va l`a na`vm. Lahu m`a fis-sam`av`ati va m`a fil arz. Manzallaz`iy yashfa'u ‘indah`u ill`a bi'iznih. Ya'lamu m`a bayna ayd`ihim va m`a xolfahum va l`a yux`it`una bi shay'im-min ‘ilmih`i ill`a bima sh`a'a. Vasi'a kursiyyuhus-sam`av`ati val arz. Va l`a ya'`uduh`u hifzuhum`a va huval ‘alliyyul ‘az`iym.":
      "Alloh - Undan o‘zga iloh yo‘q zotdir. U tirik va qayyumdir. Uni mudroq ham, uyqu ham olmas. Osmonlaru yerdagi narsalar Unikidir. Uning huzurida O‘zining iznisiz hech kim shafoat qila olmas. U ularning oldilaridagi narsani ham, ortlaridagi narsani ham bilur. Uning ilmidan hech narsani ihota qila olmaslar, magar O‘zi xohlaganini, xalos. Uning kursisi osmonlaru yerni qamragan. Ularni muhofaza qilish Uni charchatmas. Va U Oliy va Azim zotdir",
  "Alhamdulillahi robbil 'aalamiyn. Ar-rohmananir rahiym. Maaliki yavmiddiyn. Iyyaka na'budu va iyyaka nasta'iyn. Ihdinas-sirootol mustaqiym. Sirootol-laziyna an'amta 'alayhim g'oyril mag'zuubi 'alayhim valaddoliyn":
      "Hamd olamlarning Robbi - Allohgadir. U Rohman va Rohiymdir. Jazo-mukofot kunining egasidir. Faqat Sengagina ibodat qilamiz va faqat Sendangina yordam so'raymiz. Bizni to'g'ri yo'lga hidoyat qilgin. O'zing ne'mat berganlarning yo'liga. G'azabga qolganlarnikiga ham emas, adashganlarnikiga ham emas",
  ...
  "Allohumma, Robbanaa, aatinaa fid-dunya hasanatan va fil-aaxiroti hasanatan va qinaa 'azaaban-naar":
      "Allohim! Robbimiz! Bizga dunyoda ham, oxiratda ham yaxshilik ber va bizni do'zax azobidan saqla",
  "Robbi rhamhumma kamaa robbayanii sog'iyro":
      "Robbim, alar meni kichiklikda tarbiya qilganlaridek, ularga rahim qilgin",
  "Allohumma robba hazihid da'vatit tammah vassolatil qoimah, ati Muhammadanil vasiylata val faziylah vab'ashu maqomam mahmudanillaziy va'adtah. Innaka laa tuxliful miy'aad":
      "Ey bu komil duoning va qoim bo'lgan namozning egasi Allohim, Muhammadga vasila va fazilat ber, u zotni va'da qilganing maqtovli maqomda tiriltir. Albatta Sen va'dangga xilof qilmassan",
  "Subhana zil mulki val malakuti, subhana zil 'izzati va 'azomati val qudroti va kibriyai val javaruti, subhanal malikil hayyil laziy la yamutu, subbuhun quddusur Robbuna va Robbul malaikati var ruhi, la ilaha illalohu nastag'firulloh, va nasalukal jannata na na'uzu bika minan nar":
      "Mulk va malakat Egasini poklab yod etaman! Izzat, buyuklik, qudrat, ulug'vorlik va hukmronlik Egasini poklab yod etaman! Hargiz o'lmaydigan Hayyni, Malikni poklab yod etaman! U Zot Subbuhdir, Quddusdir, bizning Robbimizdir. Allohdan O'zga iloh yo'q! Allohdan mag'firat so'raymiz. Sendan jannat so'raymiz va do'zaxdan O'zingdan panoh tilaymiz",
